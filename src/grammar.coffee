# The MateScript parser is generated by [Jison](http://github.com/zaach/jison)
# from this grammar file. Jison is a bottom-up parser generator, similar in
# style to [Bison](http://www.gnu.org/software/bison), implemented in PHP.
...
grammar =
  ...
  # MateScript is the **Expression** -- everything that can be an expression
  ...
  # MateScript has two different symbols for functions. `->` is for ordinary
  ...
  # In MateScript, an object literal is simply a list of assignments.
  Object: [
    o '{ AssignList OptComma }',                -> new Obj $2, $1.generated
  ]

  # Assignment of properties within an object literal can be separated by
  # comma, as in PHP, or simply by newline.
  AssignList: [
    o '',                                                       -> []
    o 'AssignObj',                                              -> [$1]
  ...
  Operation: [
    ...
    # [The existential operator](http://jashkenas.github.com/matescript/#existence).
