...
(function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      ...
      return [].concat(prelude, this.makeCode("$__ = function() {\n"), fragments, this.makeCode("\n};\n$__();\nunset($__);\n"));
    };

    Block.prototype.compileWithDeclarations = function(o) {
      var assigns, declars, exp, fragments, i, post, rest, scope, spaced, v, _i, _j, _k, _len, _len1, _len2, _ref2, _ref3, _ref4, _ref5, _ref6;
      fragments = [];
      post = [];
      _ref2 = this.expressions;
        ...
        if (declars || assigns) {
          ...
          if (declars) {
            ...
            for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
              v = _ref5[_j];
              fragments.push(this.makeCode("$" + v + " = "));
            }
            fragments.push(this.makeCode("null"));
            fragments.push(this.makeCode(";\n" + (this.spaced ? '\n' : '')));
          }
          if (assigns) {
            fragments.push(this.makeCode("" + this.tab));
            _ref6 = scope.assignedVariables();
            for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
              v = _ref6[_k];
              fragments.push(this.makeCode("$A" + v + " = "));
            }
            fragments.push(this.makeCode(";\n" + (this.spaced ? '\n' : '')));
          }
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    Obj.prototype.compileNode = function(o) {
      ...
      answer.unshift(this.makeCode("array(" + (props.length && '\n')));
  ...
  exports.Arr = Arr = (function(_super) {
    ...
    Arr.prototype.compileNode = function(o) {
      ...
      if (fragmentsToText(answer).indexOf('\n') >= 0) {
        answer.unshift(this.makeCode("array(\n" + o.indent));
        answer.push(this.makeCode("\n" + this.tab + ")"));
      } else {
        answer.unshift(this.makeCode("array("));
        answer.push(this.makeCode(")"));
